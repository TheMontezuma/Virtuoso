...
const ScrollConfig metaConf PROGMEM = { { TFT_FRAMEWDT, 14, 1, WA_CENTER }, 140, true, MAX_WIDTH-TITLE_FIX, 5000, 2, 25 };
const ScrollConfig title1Conf PROGMEM = { { TFT_FRAMEWDT, 24, 1, WA_CENTER }, 140, false, MAX_WIDTH-TITLE_FIX , 2500, 2, 25 };
...
const ScrollConfig weatherConf PROGMEM = { { TFT_FRAMEWDT, 42, 1, WA_LEFT }, WEATHER_STRING_L, true, DSP_WIDTH-TITLE_FIX-40 , 5000, 2, 26 };  // scroling textu pogody
const ScrollConfig stocksConf  PROGMEM = { { TFT_FRAMEWDT, 54, 1, WA_LEFT }, 200, true, DSP_WIDTH-TITLE_FIX-40 , 5000, 2, 26 };  // pasek giełdowy
const ScrollConfig calendar1Conf PROGMEM = { { TFT_FRAMEWDT, 54, 1, WA_LEFT }, 140, true, DSP_WIDTH-TITLE_FIX-40 , 5000, 2, 26 };
const ScrollConfig calendar2Conf PROGMEM = { { TFT_FRAMEWDT, 62, 1, WA_LEFT }, 140, true, DSP_WIDTH-TITLE_FIX-40 , 5000, 2, 26 };
#define HAS_CALENDAR_CONF
...
const WidgetConfig bitrateConf PROGMEM = { 0, 56, 1, WA_RIGHT };
...
const WidgetConfig rssiConf PROGMEM = { 2, 2, 1, WA_LEFT };  //WiFi na górze po lewej (symetrycznie do zegara)
...
const WidgetConfig vuConf PROGMEM = { 0, 42, 1, WA_CENTER };   //VU meter niżej (y42)
...
const BitrateConfig fullbitrateConf PROGMEM = { { 232, 56, 1, WA_RIGHT }, 24 };
